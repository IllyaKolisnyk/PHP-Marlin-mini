                            ...
                            <?php
                                $array_elements = [
                                        $array_MyTasks = [
                                             ...
                                             'style-width_and_aria-valuenow' => '65'
                                        ],
                                        $array_Transfered = [
                                            'heading' => 'Transfered',
                                            'text' => '440 ТВ',
                                            'progress-bar' => 'bg-success-500',
                                            'style-width_and_aria-valuenow' => '34'
                                        ],
                                        $array_BugsSquashed = [
                                            'heading' => 'Bugs Squashed',
                                            'text' => '77%',
                                            'progress-bar' => 'bg-info-400',
                                            'style-width_and_aria-valuenow' => '77'
                                        ],
                                        $array_UserTesting = [
                                            'heading' => 'User Testing',
                                            'text' => '7 days',
                                            'progress-bar' => 'bg-primary-300',
                                            'style-width_and_aria-valuenow' => '84'
                                        ]
                                ];
                                foreach ($array_elements as $element):
                                ?>
                                <div class="d-flex">
                                <?php echo $element['heading']; ?>
                                <span class="d-inline-block ml-auto"><?php echo $element['text']; ?></span>
                            </div>
                            <div class="progress progress-sm mb-3">
                                <div class="progress-bar <?php echo $element['progress-bar']; ?>" role="progressbar" style="width: <?php echo $element['style-width_and_aria-valuenow']; ?>%;" aria-valuenow="<?php echo $element['style-width_and_aria-valuenow']; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <?php endforeach;?>
                        </div>
                    </div>
